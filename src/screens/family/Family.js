...
//   // קונטיינר רקע לכל התמונות + הכפתור
//   childrenContainer: {
//     backgroundColor: 'rgba(141, 68, 119, 0.29)', // אפור בהיר שקוף
//     borderRadius: 20,
//     padding: 15,
//     marginHorizontal: 10,
//     marginTop: 10,
...
//     flexDirection: 'row',
//     flexWrap: 'wrap',
//     justifyContent: 'center',  // מרכז את הכפתורים בציר האנכי
//     alignItems: 'center',      // מרכז את הכפתורים בציר הרוחבי
//     gap: 10,
//   },
...
//   borderRadius: 50,
//   overflow: 'hidden',
//   justifyContent: 'center',   // מרכז את התמונה בתוך התיבה
//   alignItems: 'center',       // מרכז את התמונה בתוך התיבה
// },

//   // תמונת הילד + שכבת הבהרה
//   childImage: {
...
//     ...StyleSheet.absoluteFillObject, // כיסוי מלא על התמונה
//     backgroundColor: 'rgba(143, 125, 137, 0.25)', // שחור שקוף
//     borderRadius: 15,
//   },
...
//     fontSize: 18,
//     fontWeight: 'bold',
//     textShadowColor: 'rgba(63, 19, 57, 0.23)', // צבע הצל
//     textShadowOffset: { width: 1, height: 1 }, // כיוון וגודל הצל
